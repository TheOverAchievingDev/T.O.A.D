...
Last audit: 2026-04-30 (after the deterministic-state-machine slice).
...
2. **Role authority (§5 + §26)** — CRITICAL. **NEXT SLICE.** Add `actor.role`, per-role allow-list in `LocalToolFacade.execute`, self-review prevention.
