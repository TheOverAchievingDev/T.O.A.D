export const COMMANDS = Object.freeze({
  ...
  IDE_DIAGNOSTICS_RUN: 'ide_diagnostics_run',
  IDE_FORMAT_FILE: 'ide_format_file',
  IDE_FIX_FILE: 'ide_fix_file',
  ...
  AGENT_SWAP_PROVIDER: 'agent_swap_provider',
  ...
  EAS_PROJECT_INFO: 'eas_project_info',
  EAS_BUILD: 'eas_build',
  EAS_UPDATE: 'eas_update',
  VERCEL_LINK: 'vercel_link',
  VERCEL_ENV_PULL: 'vercel_env_pull',
  VERCEL_DEPLOY: 'vercel_deploy',
  VERCEL_LS: 'vercel_ls',
  PLUGIN_JOB_GET: 'plugin_job_get',
  PLUGIN_JOB_LIST: 'plugin_job_list',
...
export const MUTATING_COMMANDS = Object.freeze([
  ...
  COMMANDS.IDE_WRITE_FILE,
  COMMANDS.IDE_FORMAT_FILE,
  COMMANDS.IDE_FIX_FILE,
  COMMANDS.IDE_FIX_PROJECT,
  COMMANDS.IDE_CHECKPOINT_TASK,
  COMMANDS.IDE_APPLY_PATCH,
  COMMANDS.CROSS_TEAM_SEND,
  COMMANDS.AGENT_LAUNCH,
  COMMANDS.AGENT_STOP,
  COMMANDS.AGENT_SWAP_PROVIDER,
  ...
  COMMANDS.PLUGIN_LOGIN,
  COMMANDS.PLUGIN_LOGOUT,
  COMMANDS.RAILWAY_LINK,
  COMMANDS.RAILWAY_PROVISION_DB,
  COMMANDS.RAILWAY_RUN_MIGRATION,
  COMMANDS.EAS_BUILD,
  COMMANDS.EAS_UPDATE,
  COMMANDS.VERCEL_LINK,
  COMMANDS.VERCEL_ENV_PULL,
  COMMANDS.VERCEL_DEPLOY,
