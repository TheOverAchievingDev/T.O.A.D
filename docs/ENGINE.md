...
This document describes the local orchestration engine behind **Symphony AI** (formerly TOAD).

The product is now branded as Symphony AI. The app has been promoted to the repository root; `TOAD_*` environment variables and several internal class names remain for compatibility while the project is renamed in stages.
